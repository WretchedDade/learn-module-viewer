                        ...
                        <div className="space-y-6">
                            ...
                            <div className="border-b border-zinc-700 pb-4">
                                <div className="flex items-center gap-3 mb-2">
                                    ...
                                    <h2 className="text-xl font-semibold text-zinc-200">Content Loaded Successfully</h2>
                                </div>
                            ...
                            <div className="space-y-4">
                                {isModule(result.content) && (
                                    <div>
                                        <h3 className="text-lg font-medium text-zinc-200 mb-3">Module Overview</h3>
                                        <div className="bg-zinc-900 rounded-lg p-4 space-y-3">
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-3 border-t border-zinc-700">
                                                ...
                                                <div className="text-center">
                                                    ...
                                                    <div className="text-xs text-zinc-500">Levels</div>
                                                </div>
                                                <div className="text-center">
                                ...
                                {isLearningPath(result.content) && (
                                    <div>
                                        <h3 className="text-lg font-medium text-zinc-200 mb-3">Learning Path Overview</h3>
                                        <div className="bg-zinc-900 rounded-lg p-4 space-y-3">
                                            <div className="flex items-start gap-3">
                                                <div className="flex-1">
                                                    <h4 className="font-semibold text-zinc-200 mb-1">
                                ...
                                {/* Performance Details */}
                                <div>
                                    <h3 className="text-lg font-medium text-zinc-200 mb-3">Performance</h3>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="border-b border-zinc-700 pb-4">
                                <div className="flex items-center gap-3 mb-2">
                                    ...
                                    <h2 className="text-xl font-semibold text-zinc-200">Error Loading Content</h2>
                                </div>
                                <p className="text-zinc-400 text-sm">
